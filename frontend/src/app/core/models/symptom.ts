...
export const SYMPTOM_GROUPS: SymptomCategory[] = [
  ...
  },
  {
    ...
    symptoms: [
      ...
      {
        key: 'distension_abdominal',
        label: 'Distensión abdominal',
        species: 'both',
      },
      { key: 'dolor_abdominal', label: 'Dolor abdominal', species: 'both' },
      { key: 'mal_aliento', label: 'Mal aliento', species: 'both' },
    ],
  },
  {
    groupKey: 'peso_apetito',
    label: 'Peso y apetito',
    icon: 'scale-outline',
    symptoms: [
      { key: 'perdida_peso', label: 'Pérdida de peso', species: 'both' },
      { key: 'aumento_peso', label: 'Aumento de peso', species: 'both' },
      { key: 'aumento_apetito', label: 'Aumento de apetito', species: 'both' },
      { key: 'aumento_sed', label: 'Aumento de sed', species: 'both' },
    ],
  },
  {
    ...
    symptoms: [
      ...
      {
        key: 'intolerancia_ejercicio',
        label: 'Intolerancia al ejercicio',
        species: 'both',
      },
    ],
  },
  ...
  },
  {
    ...
    symptoms: [
      ...
      { key: 'cojera', label: 'Cojera', species: 'both' },
      {
        key: 'rigidez_articular',
        label: 'Rigidez articular',
        species: 'both',
      },
    ],
  },
  {
    ...
    icon: 'ear-outline',
    symptoms: [
      { key: 'sacudida_cabeza', label: 'Sacudida de cabeza', species: 'both' },
    ],
  },
];
